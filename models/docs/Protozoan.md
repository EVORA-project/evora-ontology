...
URI: [EVORA:Protozoan](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#Protozoan)
...
```mermaid
 classDiagram
    ...
    Protozoan --> "*" ProductCategory : additionalCategory
    ...
    Protozoan --> "0..1" ContactPoint : contactPoint
    ...
    Protozoan --> "0..1" RiskGroup : riskGroup
...
| ---  | ---  |
| self | EVORA:Protozoan |
| native | EVORA:Protozoan |
| close | wd:Q101274 |
