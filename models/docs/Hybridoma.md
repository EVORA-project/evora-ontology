...
URI: [EVORA:Hybridoma](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#Hybridoma)
...
```mermaid
 classDiagram
    ...
    Hybridoma --> "*" ProductCategory : additionalCategory
    ...
    Hybridoma --> "0..1" ContactPoint : contactPoint
    ...
    Hybridoma --> "0..1" RiskGroup : riskGroup
    ...
    Hybridoma --> "*" SequenceReference : sequenceReference
...
| [productionSystem](productionSystem.md) | 0..1 <br/> [String](String.md) | The biological and technological methods and processes used to produce the an... | [Antibody](Antibody.md) |
...
| [specificityDocumented](specificityDocumented.md) | 1 <br/> [Boolean](Boolean.md) | Tell if the antibody specificity was documented | [Antibody](Antibody.md) |
...
| [sequenceReference](sequenceReference.md) | * <br/> [SequenceReference](SequenceReference.md) | A reference that permits to retreive the sequence information from a sequence... | [Antibody](Antibody.md) |
...
| ---  | ---  |
| self | EVORA:Hybridoma |
| native | EVORA:Hybridoma |
| close | wd:Q27554370 |
