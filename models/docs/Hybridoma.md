...
| [sequenceReference](sequenceReference.md) | * _recommended_ <br/> [SequenceReference](SequenceReference.md) | A reference that permits to retreive the sequence information from a sequence... | [Antibody](Antibody.md) |
