...
_A short explanation of the characteristics, features, or nature of the current item_





URI: [EVORAO:description](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#description)
...
* Describe this item in few lines. This description will serve as a summary to present the item.
...
| ---  | ---  |
| self | EVORAO:description |
| native | EVORAO:description |
| exact | dct:description |
...
```yaml
name: description
description: A short explanation of the characteristics, features, or nature of the
  current item
title: description
comments:
- 'Describe this item in few lines. This description will serve as a summary to present
  the item.
