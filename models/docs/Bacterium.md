...
URI: [EVORA:Bacterium](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#Bacterium)
...
```mermaid
 classDiagram
    ...
    Bacterium --> "*" ProductCategory : additionalCategory
    ...
    Bacterium --> "0..1" ContactPoint : contactPoint
    ...
    Bacterium --> "0..1" RiskGroup : riskGroup
...
| ---  | ---  |
| self | EVORA:Bacterium |
| native | EVORA:Bacterium |
| close | wd:Q10876 |
