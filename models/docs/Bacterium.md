...
```mermaid
 classDiagram
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Bacterium : canItBeUsedToProduceGMO
    ...
    Bacterium --> "1" CultivabilityEnumeration : cultivability
    ...
    Bacterium --> "1" GenomeSequencingEnumeration : genomeSequencing
    click GenomeSequencingEnumeration href "../GenomeSequencingEnumeration"

        
      Bacterium : hasIATAClassification
        
          
    
    
    Bacterium --> "1" IATAClassification : hasIATAClassification
    ...
    Bacterium --> "1" InfectivityEnumeration : infectivity
    ...
    Bacterium --> "1" LetterOfAuthorityEnumeration : letterOfAuthority
    ...
    Bacterium --> "0..1" MSDS : materialSafetyDataSheet
    ...
    click Provider href "../Provider"
      ...
      Bacterium : relatedDOI
        
          
    
    
    Bacterium --> "*" DOI : relatedDOI
    click DOI href "../DOI"
