...
```mermaid
 classDiagram
    ...
    Virus --> "1" CultivabilityEnumeration : cultivability
    ...
    Virus --> "1" GenomeSequencingEnumeration : genomeSequencing
    ...
    Virus --> "1" InfectivityEnumeration : infectivity
    ...
    Virus --> "1" LetterOfAuthorityEnumeration : letterOfAuthority
