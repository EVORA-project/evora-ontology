...
```mermaid
 classDiagram
    ...
    click PdbReference href "../PdbReference"
      ...
      PdbReference : dateIssued
        
      PdbReference : dateModified
        
      PdbReference : description
        
      PdbReference : identifier
    ...
    PdbReference --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"

        
      PdbReference : iri
        
      PdbReference : keyword
        
      PdbReference : publisher
        
          
    
    
    PdbReference --> "0..1" PersonOrOrganization : publisher
