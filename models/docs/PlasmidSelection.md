...
_The process of identifying cells that have successfully incorporated a plasmid, typically using antibiotic resistance markers._
...
```mermaid
 classDiagram
    ...
    click PlasmidSelection href "../PlasmidSelection"
      ...
      PlasmidSelection : dateIssued
        
      PlasmidSelection : dateModified
        
      PlasmidSelection : description
        
      PlasmidSelection : identifier
    ...
    PlasmidSelection --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"

        
      PlasmidSelection : iri
        
      PlasmidSelection : keyword
        
      PlasmidSelection : publisher
        
          
    
    
    PlasmidSelection --> "0..1" PersonOrOrganization : publisher
