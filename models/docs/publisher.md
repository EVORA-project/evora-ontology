...
_The entity responsible for making the resource available._
...
| [FundingSource](FundingSource.md) | A program, grant, or project providing financial support for the access or us... |  no  |
...
* Range: [PersonOrOrganization](PersonOrOrganization.md)
...
* Resources of type foaf:Agent like EVORAO:PersonOrOrganization are recommended as values for this property.
...
title: publisher
comments:
- Resources of type foaf:Agent like EVORAO:PersonOrOrganization are recommended as
