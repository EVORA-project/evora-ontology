...
_List of other names for things._
...
```mermaid
 classDiagram
    ...
    AlternateName --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"
      ...
      AlternateName : publisher
        
          
    
    
    AlternateName --> "0..1" PersonOrOrganization : publisher
