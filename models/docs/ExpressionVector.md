...
_A reference to an expression vector plasmid, typically embedding a resistance marker for inducible protein expression._
...
```mermaid
 classDiagram
    ...
    click ExpressionVector href "../ExpressionVector"
      ...
      ExpressionVector : dateIssued
        
      ExpressionVector : dateModified
        
      ExpressionVector : description
        
      ExpressionVector : identifier
    ...
    ExpressionVector --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"

        
      ExpressionVector : iri
        
      ExpressionVector : keyword
        
      ExpressionVector : publisher
        
          
    
    
    ExpressionVector --> "0..1" PersonOrOrganization : publisher
