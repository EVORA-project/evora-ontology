...
URI: [EVORA:Pathogen](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#Pathogen)
...
```mermaid
 classDiagram
    ...
    Pathogen --> "*" ProductCategory : additionalCategory
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Pathogen : canItBeUsedToProduceGMO
    ...
    Pathogen --> "0..1" ContactPoint : contactPoint
    ...
    Pathogen --> "1" IATAClassification : hasIATAClassification
    ...
    Pathogen --> "0..1" MSDS : materialSafetyDataSheet
    ...
    Pathogen --> "0..1" RiskGroup : riskGroup
