...
URI: [EVORA:Pathogen](https://evora-project.eu/Pathogen)


[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Virus],[Viroid],[TransmissionMethod],[Sequence],[RiskGroup],[Provider],[Protozoan],[PropagationHost],[ProductionCellLine],[ProductCategory],[Product],[Prion],[PathogenIdentification],[Sequence]<sequence%201..*-++[Pathogen&#124;cultivability:string;clinicalInformation:string%20%3F;identificationTechnique:string%20%3F;infectivity:string;infectivityTest:string%20%3F;isolationTechnique:string%20%3F;isolationConditions:string%20%3F;letterOfAuthority:string;passage:string%20%3F;sequencing:string;titer:string;shippingConditions(i):string;storageConditions(i):string;thirdPartyDistributionConsent(i):boolean%20%3F;usageRestrictions(i):string%20%3F;accessPointURL(i):uri;refSKU(i):string;unitDefinition(i):string%20%3F;unitCost(i):string;qualityGrading(i):string%20%3F;biosafetyRestrictions(i):string%20%3F;canItBeUsedToProduceGMO(i):boolean%20%3F;availability(i):string;technicalRecommendation(i):string%20%3F;internalReference(i):string%20%3F;note(i):string%20%3F;name(i):string;description(i):string%20%3F],[TransmissionMethod]<transmissionMethod%200..*-++[Pathogen],[PropagationHost]<propagationHost%200..*-++[Pathogen],[ProductionCellLine]<productionCellLine%200..*-++[Pathogen],[IsolationHost]<isolationHost%200..*-++[Pathogen],[GeographicalOrigin]<suspectedEpidemiologicalOrigin%200..*-++[Pathogen],[BiologicalMaterialOrigin]<biologicalMaterialOrigin%201..1-++[Pathogen],[Pathogen]^-[Virus],[Pathogen]^-[Viroid],[Pathogen]^-[Protozoan],[Pathogen]^-[Prion],[Pathogen]^-[Fungus],[Pathogen]^-[Bacterium],[Product]^-[Pathogen],[Originator],[MSDS],[Keyword],[IsolationHost],[Image],[IATAClassification],[GeographicalOrigin],[Fungus],[ExternalRelatedReference],[Document],[DOI],[ContactPoint],[Collection],[Certification],[BiologicalMaterialOrigin],[Bacterium])](https://yuml.me/diagram/nofunky;dir:TB/class/[Virus],[Viroid],[TransmissionMethod],[Sequence],[RiskGroup],[Provider],[Protozoan],[PropagationHost],[ProductionCellLine],[ProductCategory],[Product],[Prion],[PathogenIdentification],[Sequence]<sequence%201..*-++[Pathogen&#124;cultivability:string;clinicalInformation:string%20%3F;identificationTechnique:string%20%3F;infectivity:string;infectivityTest:string%20%3F;isolationTechnique:string%20%3F;isolationConditions:string%20%3F;letterOfAuthority:string;passage:string%20%3F;sequencing:string;titer:string;shippingConditions(i):string;storageConditions(i):string;thirdPartyDistributionConsent(i):boolean%20%3F;usageRestrictions(i):string%20%3F;accessPointURL(i):uri;refSKU(i):string;unitDefinition(i):string%20%3F;unitCost(i):string;qualityGrading(i):string%20%3F;biosafetyRestrictions(i):string%20%3F;canItBeUsedToProduceGMO(i):boolean%20%3F;availability(i):string;technicalRecommendation(i):string%20%3F;internalReference(i):string%20%3F;note(i):string%20%3F;name(i):string;description(i):string%20%3F],[TransmissionMethod]<transmissionMethod%200..*-++[Pathogen],[PropagationHost]<propagationHost%200..*-++[Pathogen],[ProductionCellLine]<productionCellLine%200..*-++[Pathogen],[IsolationHost]<isolationHost%200..*-++[Pathogen],[GeographicalOrigin]<suspectedEpidemiologicalOrigin%200..*-++[Pathogen],[BiologicalMaterialOrigin]<biologicalMaterialOrigin%201..1-++[Pathogen],[Pathogen]^-[Virus],[Pathogen]^-[Viroid],[Pathogen]^-[Protozoan],[Pathogen]^-[Prion],[Pathogen]^-[Fungus],[Pathogen]^-[Bacterium],[Product]^-[Pathogen],[Originator],[MSDS],[Keyword],[IsolationHost],[Image],[IATAClassification],[GeographicalOrigin],[Fungus],[ExternalRelatedReference],[Document],[DOI],[ContactPoint],[Collection],[Certification],[BiologicalMaterialOrigin],[Bacterium])
