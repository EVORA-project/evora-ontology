...
URI: [EVORAO:Prion](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#Prion)
...
```mermaid
 classDiagram
    ...
    Prion --> "1" CultivabilityEnumeration : cultivability
    ...
    Prion --> "1" GenomeSequencingEnumeration : genomeSequencing
    click GenomeSequencingEnumeration href "../GenomeSequencingEnumeration"

        
      Prion : hasIATAClassification
        
          
    
    
    Prion --> "1" IATAClassification : hasIATAClassification
    ...
    Prion --> "1" InfectivityEnumeration : infectivity
    ...
    Prion --> "1" LetterOfAuthorityEnumeration : letterOfAuthority
    ...
    Prion --> "0..1" MSDS : materialSafetyDataSheet
