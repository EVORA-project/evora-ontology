...
URI: [EVORA:Prion](https://raw.githubusercontent.com/EVORA-project/evora-ontology/refs/heads/main/models/owl/evora_ontology.owl.ttl#Prion)
...
```mermaid
 classDiagram
    ...
    Prion --> "*" ProductCategory : additionalCategory
    ...
    Prion --> "0..1" ContactPoint : contactPoint
