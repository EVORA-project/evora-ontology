...
```mermaid
 classDiagram
    ...
    Viroid --> "1" CultivabilityEnumeration : cultivability
    ...
    Viroid --> "1" GenomeSequencingEnumeration : genomeSequencing
    ...
    Viroid --> "1" InfectivityEnumeration : infectivity
    ...
    Viroid --> "1" LetterOfAuthorityEnumeration : letterOfAuthority
