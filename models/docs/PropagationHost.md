...
_The organism used to grow and multiply the pathogen under controlled conditions._
...
```mermaid
 classDiagram
    ...
    PropagationHost --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"
      ...
      PropagationHost : publisher
        
          
    
    
    PropagationHost --> "0..1" PersonOrOrganization : publisher
