...
_Periodical journal publishing scientific research._
...
```mermaid
 classDiagram
    ...
    Journal --> "0..1 _recommended_" Vocabulary : inVocabulary
    ...
    Journal --> "0..1" PersonOrOrganization : publisher
