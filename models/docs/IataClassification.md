...
_The corresponding International Air Transport Association (IATA)'s category for dangerous goods that are transported by air._
...
```mermaid
 classDiagram
    ...
    IataClassification --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"
      ...
      IataClassification : publisher
        
          
    
    
    IataClassification --> "0..1" PersonOrOrganization : publisher
