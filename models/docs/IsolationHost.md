...
_Host organism from which the pathogen was isolated._
...
```mermaid
 classDiagram
    ...
    click IsolationHost href "../IsolationHost"
      ...
      IsolationHost : dateIssued
        
      IsolationHost : dateModified
        
      IsolationHost : description
        
      IsolationHost : identifier
    ...
    IsolationHost --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"

        
      IsolationHost : iri
        
      IsolationHost : keyword
        
      IsolationHost : publisher
        
          
    
    
    IsolationHost --> "0..1" PersonOrOrganization : publisher
