...
_A short description of what is delivered when one unit of this item is ordered, such as quantity or packaging._
...
```yaml
name: unitDefinition
description: A short description of what is delivered when one unit of this item is
  ordered, such as quantity or packaging.
