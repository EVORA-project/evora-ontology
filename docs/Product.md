...
_A tangible, physical item made available by a provider for use, consumption, or ownership transfer._
...
```mermaid
 classDiagram
    ...
    click ProductCategory href "../ProductCategory"
      ...
      Product : biosafetyLevel
        
          
    
    
    Product --> "0..1" BiosafetyLevel : biosafetyLevel
    ...
    Product --> "0..1" PersonOrOrganization : publisher
