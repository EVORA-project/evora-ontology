...
_The protozoan as a biological material._
...
```mermaid
 classDiagram
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Protozoan : biosafetyLevel
        
          
    
    
    Protozoan --> "0..1" BiosafetyLevel : biosafetyLevel
    click BiosafetyLevel href "../BiosafetyLevel"

        
      Protozoan : biosafetyRestrictions
        
      Protozoan : canBeUsedToProduceGmo
    ...
    click ContactPoint href "../ContactPoint"
      ...
      Protozoan : dateIssued
        
      Protozoan : dateModified
    ...
    click ExternalRelatedReference href "../ExternalRelatedReference"
      ...
      Protozoan : fundingSource
        
          
    
    
    Protozoan --> "*" FundingSource : fundingSource
    click FundingSource href "../FundingSource"

        
      Protozoan : genomeSequencing
        
      Protozoan : iataClassification
        
          
    
    
    Protozoan --> "1" IataClassification : iataClassification
    click IataClassification href "../IataClassification"

        
      Protozoan : identificationTechnique
        
      Protozoan : identifier
    ...
    Protozoan --> "0..1" MaterialSafetyDataSheet : materialSafetyDataSheet
    ...
    click PathogenIdentification href "../PathogenIdentification"
      ...
      Protozoan : preparationTechnique
    ...
    Protozoan --> "0..1" PersonOrOrganization : publisher
    ...
    click TransmissionMethod href "../TransmissionMethod"
      ...
      Protozoan : unitCostCurrency
        
      Protozoan : unitCostNote
...
| related | snomed:95896000, snomed:417396000, snomed:95896000, snomed:417396000 |
| close | wd:Q101274, schema:Protozoa, vo:0000333, wd:Q101274, schema:Protozoa, vo:0000333 |
