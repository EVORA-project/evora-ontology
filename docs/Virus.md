...
_The virus as a biological material._
...
```mermaid
 classDiagram
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Virus : biosafetyLevel
        
          
    
    
    Virus --> "0..1" BiosafetyLevel : biosafetyLevel
    ...
    Virus --> "*" FundingSource : fundingSource
    ...
    Virus --> "0..1" PersonOrOrganization : publisher
