...
_Protein that can bind to certain types of foreign bodies, such as pathogens._
...
```mermaid
 classDiagram
    ...
    click ProductCategory href "../ProductCategory"
      ...
      Antibody : biosafetyLevel
        
          
    
    
    Antibody --> "0..1" BiosafetyLevel : biosafetyLevel
    ...
    click ExternalRelatedReference href "../ExternalRelatedReference"
      ...
      Antibody : fundingSource
        
          
    
    
    Antibody --> "*" FundingSource : fundingSource
    ...
    Antibody --> "0..1" MaterialSafetyDataSheet : materialSafetyDataSheet
    ...
    Antibody --> "0..1" PersonOrOrganization : publisher
