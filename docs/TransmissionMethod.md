...
_The process by which the pathogen spreads between hosts._
...
```mermaid
 classDiagram
    ...
    TransmissionMethod --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"
      ...
      TransmissionMethod : publisher
        
          
    
    
    TransmissionMethod --> "0..1" PersonOrOrganization : publisher
