...
_The fungus as a biological material._





URI: [EVORAO:Fungus](https://w3id.org/evorao/Fungus)
...
```mermaid
 classDiagram
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Fungus : biosafetyLevel
        
          
    
    
    Fungus --> "0..1" BiosafetyLevel : biosafetyLevel
    click BiosafetyLevel href "../BiosafetyLevel"

        
      Fungus : biosafetyRestrictions
        
      Fungus : canBeUsedToProduceGmo
    ...
    click ExternalRelatedReference href "../ExternalRelatedReference"
      ...
      Fungus : fundingSource
        
          
    
    
    Fungus --> "*" FundingSource : fundingSource
    click FundingSource href "../FundingSource"

        
      Fungus : genomeSequencing
        
      Fungus : iataClassification
        
          
    
    
    Fungus --> "1" IataClassification : iataClassification
    ...
    Fungus --> "0..1" MaterialSafetyDataSheet : materialSafetyDataSheet
    ...
    Fungus --> "0..1" PersonOrOrganization : publisher
    ...
    Fungus --> "1..* _recommended_" Sequence : sequence
...
| related | snomed:414561005, ncbitaxon:4751, doid:1564, mondo:0002041, snomed:414561005, ncbitaxon:4751, doid:1564, mondo:0002041 |
| close | wd:Q764, schema:Fungus, ncit:C14209, wd:Q764, schema:Fungus, ncit:C14209 |
