...
_An hybridoma that provides antibodies that can be related to a pathogen._
...
```mermaid
 classDiagram
    ...
    click ProductCategory href "../ProductCategory"
      ...
      Hybridoma : antibodySpecificity
        
      Hybridoma : antibodyType
        
      Hybridoma : availability
        
      Hybridoma : biosafetyLevel
        
          
    
    
    Hybridoma --> "0..1" BiosafetyLevel : biosafetyLevel
    click BiosafetyLevel href "../BiosafetyLevel"

        
      Hybridoma : biosafetyRestrictions
        
      Hybridoma : canBeUsedToProduceGmo
    ...
    click ContactPoint href "../ContactPoint"
      ...
      Hybridoma : dateIssued
        
      Hybridoma : dateModified
    ...
    click ExternalRelatedReference href "../ExternalRelatedReference"
      ...
      Hybridoma : fundingSource
        
          
    
    
    Hybridoma --> "*" FundingSource : fundingSource
    click FundingSource href "../FundingSource"

        
      Hybridoma : hybridomaDescription
        
      Hybridoma : iataClassification
        
          
    
    
    Hybridoma --> "1" IataClassification : iataClassification
    click IataClassification href "../IataClassification"

        
      Hybridoma : identifier
    ...
    click PathogenIdentification href "../PathogenIdentification"
      ...
      Hybridoma : preparationTechnique
    ...
    Hybridoma --> "0..1" PersonOrOrganization : publisher
    ...
    click SequenceReference href "../SequenceReference"
      ...
      Hybridoma : unitCostCurrency
        
      Hybridoma : unitCostNote
...
| [antibodySpecificity](antibodySpecificity.md) | 0..1 <br/> [String](String.md) | Information describing the molecular or antigenic specificity of the antibody... | [Antibody](Antibody.md) |
...
attributes:
  ...
  antibodySpecificity:
    ...
    description: Information describing the molecular or antigenic specificity of
      the antibody, including its recognized target(s), cross-reactivity with related
      antigens, and any contextual information supporting its selectivity.
