...
```mermaid
 classDiagram
    ...
    click MaterialSafetyDataSheet href "../MaterialSafetyDataSheet"
      ...
      MaterialSafetyDataSheet : identifier
        
      MaterialSafetyDataSheet : iri
    ...
    click ContactPoint href "../ContactPoint"
      ...
      MaterialSafetyDataSheet : publisher
        
          
    
    
    MaterialSafetyDataSheet --> "0..1" PersonOrOrganization : publisher
