...
_Conceptual entity that groups one or more populations of an organism or organisms, as seen by taxonomists, to form a unit._
...
```mermaid
 classDiagram
    ...
    Taxon --> "0..1" PersonOrOrganization : publisher
...
slot_usage:
  ...
  previouslyKnownAs:
    ...
    deprecated: Deprecated in favor of EVORAO:alternateName. Use EVORAO:alternateName
      ...
      was limited to historical taxon names and required a Taxon value, which made
