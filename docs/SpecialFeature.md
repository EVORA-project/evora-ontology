...
```mermaid
 classDiagram
    ...
    click SpecialFeature href "../SpecialFeature"
      ...
      SpecialFeature : dateIssued
        
      SpecialFeature : dateModified
        
      SpecialFeature : description
        
      SpecialFeature : identifier
    ...
    SpecialFeature --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"

        
      SpecialFeature : iri
        
      SpecialFeature : keyword
        
      SpecialFeature : publisher
        
          
    
    
    SpecialFeature --> "0..1" PersonOrOrganization : publisher
