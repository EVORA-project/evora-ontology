...
_Biological entity that causes disease in its host, which is typically an infectious microorganism or agent, such as a virus, bacterium, protozoan, prion, viroid, or fungus._
...
```mermaid
 classDiagram
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Pathogen : biosafetyLevel
        
          
    
    
    Pathogen --> "0..1" BiosafetyLevel : biosafetyLevel
    ...
    Pathogen --> "0..1" MaterialSafetyDataSheet : materialSafetyDataSheet
    ...
    Pathogen --> "0..1" PersonOrOrganization : publisher
