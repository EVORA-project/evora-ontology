...
_The bacterium as a biological material._
...
```mermaid
 classDiagram
    ...
    click Bacterium href "../Bacterium"
      ...
      Bacterium : accessPointUrl
        
      Bacterium : additionalCategory
        
          
    
    
    Bacterium --> "* _recommended_" ProductCategory : additionalCategory
    click ProductCategory href "../ProductCategory"

        
      Bacterium : availability
        
      Bacterium : biologicalMaterialOrigin
        
          
    
    
    Bacterium --> "1" BiologicalMaterialOrigin : biologicalMaterialOrigin
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"

        
      Bacterium : biosafetyLevel
        
          
    
    
    Bacterium --> "0..1" BiosafetyLevel : biosafetyLevel
    click BiosafetyLevel href "../BiosafetyLevel"

        
      Bacterium : biosafetyRestrictions
        
      Bacterium : canBeUsedToProduceGmo
    ...
    Bacterium --> "1" ProductCategory : category
    click ProductCategory href "../ProductCategory"

        
      Bacterium : certification
        
          
    
    
    Bacterium --> "*" Certification : certification
    click Certification href "../Certification"

        
      Bacterium : clinicalInformation
        
      Bacterium : collection
        
          
    
    
    Bacterium --> "1..*" Collection : collection
    click Collection href "../Collection"

        
      Bacterium : complementaryDocument
        
          
    
    
    Bacterium --> "*" Document : complementaryDocument
    click Document href "../Document"

        
      Bacterium : contactPoint
        
          
    
    
    Bacterium --> "0..1 _recommended_" ContactPoint : contactPoint
    click ContactPoint href "../ContactPoint"

        
      Bacterium : cultivability
        
      Bacterium : dateIssued
        
      Bacterium : dateModified
    ...
    click Doi href "../Doi"
      ...
      Bacterium : externalRelatedReference
        
          
    
    
    Bacterium --> "*" ExternalRelatedReference : externalRelatedReference
    click ExternalRelatedReference href "../ExternalRelatedReference"

        
      Bacterium : fundingSource
        
          
    
    
    Bacterium --> "*" FundingSource : fundingSource
    click FundingSource href "../FundingSource"

        
      Bacterium : genomeSequencing
        
      Bacterium : iataClassification
        
          
    
    
    Bacterium --> "1" IataClassification : iataClassification
    click IataClassification href "../IataClassification"

        
      Bacterium : identificationTechnique
        
      Bacterium : identifier
        
      Bacterium : infectivity
        
      Bacterium : infectivityTest
        
      Bacterium : internalReference
        
      Bacterium : iri
        
      Bacterium : isolationConditions
        
      Bacterium : isolationHost
        
          
    
    
    Bacterium --> "*" IsolationHost : isolationHost
    click IsolationHost href "../IsolationHost"

        
      Bacterium : isolationTechnique
    ...
    Bacterium --> "1..*" Keyword : keywords
    click Keyword href "../Keyword"

        
      Bacterium : letterOfAuthority
        
      Bacterium : materialSafetyDataSheet
        
          
    
    
    Bacterium --> "0..1" MaterialSafetyDataSheet : materialSafetyDataSheet
    click MaterialSafetyDataSheet href "../MaterialSafetyDataSheet"

        
      Bacterium : note
        
      Bacterium : originator
        
          
    
    
    Bacterium --> "0..1" Originator : originator
    click Originator href "../Originator"

        
      Bacterium : passage
        
      Bacterium : pathogenIdentification
        
          
    
    
    Bacterium --> "1..*" PathogenIdentification : pathogenIdentification
    click PathogenIdentification href "../PathogenIdentification"

        
      Bacterium : preparationTechnique
        
      Bacterium : productionCellLine
        
          
    
    
    Bacterium --> "*" ProductionCellLine : productionCellLine
    click ProductionCellLine href "../ProductionCellLine"

        
      Bacterium : productPicture
        
          
    
    
    Bacterium --> "*" Image : productPicture
    click Image href "../Image"

        
      Bacterium : propagationHost
        
          
    
    
    Bacterium --> "*" PropagationHost : propagationHost
    ...
    Bacterium --> "0..1" PersonOrOrganization : publisher
    click PersonOrOrganization href "../PersonOrOrganization"

        
      Bacterium : qualityGrading
    ...
    Bacterium --> "0..1 _recommended_" RiskGroup : riskGroup
    ...
    Bacterium --> "1..* _recommended_" Sequence : sequence
    click Sequence href "../Sequence"

        
      Bacterium : shippingConditions
        
      Bacterium : storageConditions
        
      Bacterium : suspectedEpidemiologicalOrigin
        
          
    
    
    Bacterium --> "*" GeographicalOrigin : suspectedEpidemiologicalOrigin
    click GeographicalOrigin href "../GeographicalOrigin"

        
      Bacterium : technicalRecommendation
        
      Bacterium : thirdPartyDistributionConsent
        
      Bacterium : titer
        
      Bacterium : title
        
      Bacterium : transmissionMethod
        
          
    
    
    Bacterium --> "*" TransmissionMethod : transmissionMethod
...
| [letterOfAuthority](letterOfAuthority.md) | 0..1 _recommended_ <br/> [String](String.md) | Indicate whether a Letter of Authority is required, confirming the necessity ... | [Pathogen](Pathogen.md) |
...
| [unitDefinition](unitDefinition.md) | 0..1 _recommended_ <br/> [String](String.md) | A short description of what is delivered when one unit of this item is ordere... | [ProductOrService](ProductOrService.md) |
...
| [canBeUsedToProduceGmo](canBeUsedToProduceGmo.md) | 0..1 _recommended_ <br/> [Boolean](Boolean.md) | Indicates if the current service or product can be used to produce GMO | [ProductOrService](ProductOrService.md) |
