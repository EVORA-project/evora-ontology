...
_A population of cells that originates from a primary culture, adapted to grow and divide under laboratory conditions. Used in biotechnology to consistently produce biological substances._
...
```mermaid
 classDiagram
    ...
    ProductionCellLine --> "0..1 _recommended_" Vocabulary : inVocabulary
    click Vocabulary href "../Vocabulary"

        
      ProductionCellLine : iri
        
      ProductionCellLine : keyword
        
      ProductionCellLine : publisher
        
          
    
    
    ProductionCellLine --> "0..1" PersonOrOrganization : publisher
