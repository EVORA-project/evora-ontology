...
_The prion as a biological material._
...
```mermaid
 classDiagram
    ...
    click BiologicalMaterialOrigin href "../BiologicalMaterialOrigin"
      ...
      Prion : biosafetyLevel
        
          
    
    
    Prion --> "0..1" BiosafetyLevel : biosafetyLevel
    ...
    Prion --> "*" FundingSource : fundingSource
    ...
    Prion --> "0..1" MaterialSafetyDataSheet : materialSafetyDataSheet
    ...
    Prion --> "0..1" PersonOrOrganization : publisher
...
| self | EVORAO:Prion |
| native | EVORAO:Prion |
| related | snomed:84676004, doid:649, snomed:84676004, doid:649 |
| close | wd:Q47051, schema:Prion, xco:0000655, wd:Q47051, schema:Prion, xco:0000655 |
