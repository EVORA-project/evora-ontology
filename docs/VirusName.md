...
_A virus vernacular name or a name that describes a group of viruses._
...
```mermaid
 classDiagram
    ...
    VirusName --> "0..1 _recommended_" Vocabulary : inVocabulary
    ...
    VirusName --> "0..1" PersonOrOrganization : publisher
