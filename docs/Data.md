...
_Subclass of File representing structured or unstructured datasets, often used for analysis, storage, or transfer of information._
...
```mermaid
 classDiagram
    ...
    Data --> "0..1" PersonOrOrganization : publisher
